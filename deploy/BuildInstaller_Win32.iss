...
AppVersion=2017.7.20
DefaultDirName={pf}\SolarPILOT\2017.7.20
OutputBaseFilename=solarpilot-install-Win32
; --------
...
Source: "Win32/dbghelp.dll"; DestDir: "{app}\Win32";
Source: "Win32/libcurl.dll"; DestDir: "{app}\Win32";
Source: "Win32/libeay32.dll"; DestDir: "{app}\Win32";
Source: "Win32/libssh2.dll"; DestDir: "{app}\Win32";
Source: "Win32/ssleay32.dll"; DestDir: "{app}\Win32";
