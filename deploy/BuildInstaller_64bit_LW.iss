...
AppVersion=2016.11.29
DefaultDirName={pf}\SolarPILOT\2016.11.29
OutputBaseFilename=solarpilot-install-2016.11.29_x64_LW
; --------
...
;Source: "../nlopt/nlopt-2.4.1-dll64/libnlopt-0.dll"; DestDir: "{app}\x64";
