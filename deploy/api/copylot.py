...
class CoPylot:
    ...
    def add_land(self, p_data, add_type, poly_points, is_append = True):
        ...
        return self.pdll.sp_add_land( c_void_p(p_data), c_char_p(add_type), pointer(PParr), c_int(npts), c_int(ndim), c_bool(is_append))
...
if __name__ == "__main__":
    ...
    if True:
        ...
        if True:
            ...
            print( cp.simulate(r)) # seems to work - TODO: Check Flux map
