...
public:
	...
	wxString GetRowLabelValue(int row){return rowlabs.at(row);}
	wxString GetColLabelValue(int col){return collabs.at(col);}
	wxString GetCellValue(int row, int col){return data.at(row).at(col);}
